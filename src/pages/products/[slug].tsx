      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8 product-container">
          <div className="flex flex-col gap-2">
            ...
            <ShareButtons 
              title={product.nameZh && locale === 'zh' ? product.nameZh : product.name}
              url={typeof window !== 'undefined' ? window.location.href : ''}
            />
            <p className="text-xl text-gray-600 max-w-4xl mt-4">
              {product.descriptionZh && locale === 'zh' ? product.descriptionZh : product.description}
            </p>
          </div>
        </div>

        {/* Countdown Banner for Meowtica Smart Hub */}
        {product.slug === 'meowtica-smart-hub' && (
          <CountdownBanner />
        )}
